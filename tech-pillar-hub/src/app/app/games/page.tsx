  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-text-secondary mt-1">Study flashcards to reinforce your learning</p>
      </div>
      ...
      {cohorts.length === 0 && (
        <div className="bg-white rounded-xl border border-border shadow-sm flex flex-col items-center py-16 text-center">
          ...
          <p className="text-sm text-text-secondary">Enroll in a course to access flashcard games.</p>
        </div>
      )}
